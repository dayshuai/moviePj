...
//		System.out.println(Page.ToJsonForList(1,30,1159).toString());
		...
		try {
			...
			if (p.getShowPage()) {
				...
				if (p.getFirstPage() == p.getPageIndex()) {
					...
					html += "<li><a href=\"javascript:void(0)\" onclick=\"JumpPage('" + p.getFirstPage()
							+ "')\">首页</a></li>";
				}
				if (p.getPreviousPage() == p.getPageIndex()) {
					...
					html += "<li><a class=\"hidden-xs hidden-sm\" href=\"javascript:void(0)\" onclick=\"JumpPage('"
							+ p.getPreviousPage() + "')\"><上一页</a></li>";
					html += "<li><a class=\"hidden-lg hidden-md\" href=\"javascript:void(0)\" onclick=\"JumpPage('"
				...
				for (int i = p.getMinPage(); i <= p.getMaxPage(); i++) {
					if (i == p.getPageIndex()) {
						...
						html += "<li><a href=\"javascript:void(0)\" onclick=\"JumpPage('" + i + "')\">" + i
								+ "</a></li>";
					}
				}
				...
				if (p.getLastPage() == p.getPageIndex()) {
					...
					html += "<li><a href=\"javascript:void(0)\" onclick=\"JumpPage('" + p.getLastPage()
							+ "')\">尾页</a></li>";
				}
				html += "</ul></div>";
			}
	...
	public static String BootStarpStyleManage(Integer pageIndex, Integer pageSize, Integer totalCount) {
		PageStyle<Object> p = new PageStyle<Object>(pageIndex, pageSize, totalCount);
		try {
			String html = "";
			if (p.getShowPage()) {
				...
				if (p.getPreviousPage().intValue() == p.getPageIndex().intValue()) {
					...
					html += "<li><a href=\"javascript:void(0)\" onclick=\"JumpPage('" + p.getPreviousPage()
							+ "')\"><上一页</a></li>";
				}
				for (int i = p.getMinPage(); i <= p.getMaxPage(); i++) {
					if (i == p.getPageIndex()) {
				...
				if (p.getDoublePage() != 0) {
					html += "<li><a href=\"javascript:void(0)\" onclick=\"JumpPage('" + p.getDoublePage()
							+ "')\">...</a></li>";
				}
				if (p.getNaxtPage().intValue() == p.getPageIndex().intValue()) {
					html += "<li class='disabled'><a href=\"javascript:void(0)\">下一页></a> ";
				} else {
					html += "<li><a href=\"javascript:void(0)\" onclick=\"JumpPage('" + p.getNaxtPage()
							+ "')\">下一页></a></li>";
				}
